...
<body>
    <div class="container">
        ...
        <%
            ...
            // Initialize total working hours, late arrivals, early departures
            int lateArrivals = 0;
            ...
            try {
                ...
                {
                	sql = "SELECT clockInTime, clockOutTime FROM attendance WHERE employeeName = ? AND MONTH(date) = ? AND YEAR(date) = ?";
                ...
                {
                	sql = "SELECT clockInTime, clockOutTime FROM attendance WHERE MONTH(date) = ? AND YEAR(date) = ?";
                	statement = connection.prepareStatement(sql);
