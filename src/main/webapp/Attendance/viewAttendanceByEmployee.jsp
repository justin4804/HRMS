...
<head>
    ...
    <title>Attendance Records by Employee Name</title>
    <style>
        body {
...
<body>
    <h1>Attendance Records by Employee Name</h1>
    
    <%
        // Retrieve employee name from the request parameter
        String employeeNameParam = request.getParameter("employee");
        ...
        try {
            ...
            String sql = "SELECT e.EmployeeID, a.employeeName,a.date, a.clockInTime, a.clockOutTime FROM attendance a INNER JOIN employee e ON a.employeeName = e.FullName WHERE e.FullName = ?";
            PreparedStatement statement = connection.prepareStatement(sql);
            statement.setString(1, employeeNameParam);
