...
<head>
    ...
    <title>Past Leave Records</title>
    <style>
        <style>
        body {
...
<%
    ...
    try {
        ...
        String sql = "SELECT e.EmployeeID, l.employeeName, l.leaveType, l.startDate, l.endDate, l.reason FROM leave_request l INNER JOIN employee e ON l.employeeName = e.FullName WHERE l.startDate < CURDATE()";
